...
export default function TiffinForm() {
  ...
  function resetForm() {
    form.reset();
    calculateEndDate(form.getValues('number_of_weeks'), form, setEndDateText);
              ...
              render={({ field }) => (
                <FormItem className="flex h-full flex-col items-start justify-between">
                  ...
                  <FormControl className="w-full">
                    <div className="relative" ref={clickOutsidePhoneRef}>
                      <PhoneInput
                        placeholder="phone"
                        {...field}
                        defaultCountry="CA"
                      ...
                      {showPhoneAutocomplete && (
                        <AddressCommand
                          ...
                          setShowAutocomplete={setShowPhoneAutocomplete}
                        />
                      )}
                    </div>
                  </FormControl>
