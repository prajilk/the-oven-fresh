...
const RecentTiffinOrderTable = () => {
  const { data: orders, isPending } = useTiffinOrders(10);
    ...
    <Table
      ...
      topContent={
        <div className="flex items-center justify-between">
          <h1 className="font-medium text-lg">Recent Tiffin Orders</h1>
...
export default RecentTiffinOrderTable;
